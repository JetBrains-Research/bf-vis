...
import { generateInitialD3Hierarchy, drawTreemapFromGeneratedLayout, drawMiniTreemapFromGeneratedLayout, applyFilters, applyNormalizationToD3Hierarchy } from '../d3/treemap';
...
function TreeMap(props) {
    ...
    const dataNormalizationFunction = props.dataNormalizationFunction ? props.dataNormalizationFunction : Math.sqrt;
    ...
    useEffect(() => {
        ...
        const treemapLayoutGenerator = (treemapData) => d3.treemap()
        ...
        if (dataNormalizationFunction) {
            applyNormalizationToD3Hierarchy(rootHierarchyNode, dataNormalizationFunction);
        }
