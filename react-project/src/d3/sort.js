...
export const busFactorAscending = (a, b) => ascending(a.data.busFactor.b.data.BusFactor);
export const busFactorDescending = (a, b) => descending(a.data.busFactor.b.data.BusFactor);